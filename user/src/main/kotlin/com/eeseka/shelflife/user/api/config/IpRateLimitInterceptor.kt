package com.eeseka.shelflife.user.api.config

import com.eeseka.shelflife.user.domain.exception.RateLimitException
import com.eeseka.shelflife.user.infra.rate_limiting.IpRateLimiter
import com.eeseka.shelflife.user.infra.rate_limiting.IpResolver
...
class IpRateLimitInterceptor(
    ...
    @param:Value("\${shelflife.rate-limit.ip.apply-limit}")
